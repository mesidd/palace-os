...
// Upgraded exhibits data with slugs
const exhibits = [
  {
  ...
  {
    slug: "software-as-civilizational-tool",
    title: "Software as a Civilizational Tool",
    summary: "Viewing code not as a commercial product, but as a fundamental tool for shaping the future of human society.",
    category: "Vision",
  },
  ...
  return (
    <main>
        <div className="container mx-auto py-24 md:py-32 px-4">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="font-serif text-5xl md:text-6xl font-bold tracking-tighter text-yellow-400">
                        The Observatory
                    </h1>
                    <p className="mt-4 text-lg md:text-xl text-muted-foreground">
                        Explorations into the future of technology and its civilizational impact.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {exhibits.map((exhibit) => (
                        <Link href={`/museum/observatory/${exhibit.slug}`} key={exhibit.title} className="group block">
                            <Card className="h-full bg-card/60 border-border/60 shadow-lg hover:shadow-yellow-500/10 hover:-translate-y-2 transition-all duration-300">
                                <CardHeader>
                                    <p className="text-xs font-mono text-yellow-400/80 mb-2">{exhibit.category}</p>
                                    <CardTitle className="font-serif text-xl text-white">{exhibit.title}</CardTitle>
                                    <CardDescription className="pt-2 text-slate-400">{exhibit.summary}</CardDescription>
                                </CardHeader>
                            </Card>
